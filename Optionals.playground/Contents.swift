...
///* 2. Given optional string `backgroundColor`, write code that safely unwraps and prints it. If backgroundColor is nil, give it a value.
//
...
///* 3. Given an optional width and an optional height of a rectangle, write code that calculates and prints the area. Print an error message if either value is nil.
// */
//var width: Double?
//var height: Double?
//width = 10.00
...
///* 4. Given the following optional variables `name`, `age` and `height`.
// Write code so that it prints `name`, `age` and `height` if they all have a value.
// If any are nil, print an error message. Try using optional binding.
// */
//var name: String?
//var age: Int?
//var height: Double?
...
//}
///* 5. Given the variables `firstName`, `middleName` and `lastName`. Create a variable called `fullName` that is a nicely formatted string.
// */
...
//}
///* 6. Write code that adds 15 to `myIntString`, then prints the sum. Use the `Int()` constructor which returns an optional Int `(Int?)`.
// `let myIntString = "35"`
// */
//
//let myIntString = "35"
...
///* 7. Given an optional tuple of optional Ints, write code to safely unwrap the tuple and calculate the sum of its contents that aren't nil.
// */
...
///* 8. Safely unwrap `tuple` if there’s a non-nil tuple value and print it out.
// */
//var tuple: (Int, Int)?
//if Bool.random() {
//    tuple = (5, 3)
...
///* 9. Write code that either doubles `myInt` and then prints it, or prints an error message if myInt is nil.
// */
//
//var myInt: Int?
//
...
//}
///* 10. Write code that prints out the product of `myDouble` and `doubleTwo` or prints an error message if `myDouble` is nil.
// */
//var myDouble: Double?
...
//}
///* 11. Determine if the variable contains a Boolean or nil value. If nil set the variable to false, else keep it true.
// */
...
//    print(isTheGreatest!)
//}
///* 12. Given the code below print the sum of each non-nil element in `myTuple`.
// */
...
///* 13. Given the helper functions and code below, check to see if your `evolutionaryStone` is able to evolve your pokemon.  The table below shows the appropriate matches of pokemon to stone:
//
// | Pokemon       | Stone    |
// | :--------: | :------: |
// | Pikachu       | Electric |
...
///* 14. Given an optional int `numberOfPeople`, write code that unwraps and prints it **only if it is even**. Try using optional binding with a condition.
// */
...
//}
///* 15. Given the array of optional Ints `someNumbers`, write code to find the product of the array not including any nil values.
// */
//var someNumbers: [Int?] = []
...
///* 16. Given the array `poorlyFormattedCityNames`, create a new array with the city names capitalized and any nil values removed.
//
// poorlyFormattedCityNames: [String?] = ["new york", "BOSTON", nil, "chicago", nil, "los angeles", nil, "Dallas",]
//
...
///* 17. Given a random array of optional numbers, create a new array of all the even numbers that aren't nil.
// */
...
///* 18. Given the following array of zip codes as strings, write code that turns them into an array of Ints.
// */
...
//}
//print(zipCodeNum)
///* 19. Some students were asked some questions about their favorite foods and colors and the answers were stored in an array `studentInfo`.
//
...
//        noFavoriteFoodNames.append(studentTuple.0)
//    }
...
///* 20. Given an optional array of optional tuples of optional UInt8s,
//
...
///* 21. Consider the following nested optional. It corresponds to a number inside a box inside a box inside a box.
//
...
//    print(number3)
//}
///* 22. Given an Array of Optional Strings, write code that concatenates all non-nil values together except for strings with 3 or more vowels.
//
...
/* 23. Given the value below, print out all of the non-nil Ints it contains by accessing each of them.
